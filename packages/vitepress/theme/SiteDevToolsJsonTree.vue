...
<template>
  <div class="site-devtools-json-tree">
    <p
      v-if="jsonTreeFallbackActive"
      class="site-devtools-dialog__hint site-devtools-dialog__hint--subtle site-devtools-json-tree__fallback-note"
    >
    ...
    <component
      ...
      v-bind="viewerProps"
      class="site-devtools-json-tree__viewer"
    />
  </div>
</template>
