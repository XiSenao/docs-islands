...
const previewClasses = computed(() => [
  'site-debug-source-viewer__text',
  props.windowed && lineIndex.value
    ? 'site-debug-source-viewer__text--virtual'
    : '',
  shouldHighlightWindow.value
    ? 'site-debug-source-viewer__text--highlighted'
    : '',
        ...
        <span
          ...
          ><template v-if="line.tokens && line.tokens.length > 0"
            ><span
              ...
              class="site-debug-source-viewer__virtual-token"
