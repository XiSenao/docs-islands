...
- To refresh the reports locally, run `pnpm docs:build:site-devtools-reports` from
  `packages/vitepress/docs`, or `pnpm docs:build:site-devtools-reports` from the
  repo root.
