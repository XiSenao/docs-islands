import { importWithError, pkgExists } from '@docs-islands/utils/general';
...
let reactRuntimeDependenciesPromise: Promise<ReactRuntimeDependencies> | null =
  null;
let dependencyResolutionBase = resolveCurrentDependencyResolutionBase();
...
export function createReactDependencyBootstrapPlugin(): PluginOption {
  return {
