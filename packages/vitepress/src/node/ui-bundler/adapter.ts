...
/**
 * The generic bundler owns the "how to emit and write runtime modules" part,
 * while each framework owns the runtime source string itself.
 */
...
/**
 * A framework adapter provides the minimal hooks needed by the generic UI
 * bundler so browser, SSR, and MPA builds can stay framework-agnostic.
 */
