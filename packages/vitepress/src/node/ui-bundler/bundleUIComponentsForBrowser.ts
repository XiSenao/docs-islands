...
const Logger = loggerInstance.getLoggerByGroup(
  'bundle-ui-components-for-browser',
);
...
export async function bundleUIComponentsForBrowser(
  ...
  try {
    ...
    /**
     * Keep the framework-specific runtime source outside the shared bundler so
     * adding a new UI framework does not require changing generic build logic.
     */
