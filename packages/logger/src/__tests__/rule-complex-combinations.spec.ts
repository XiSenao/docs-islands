    ...
    it('Case 16: Message alone as filter supports exact and match', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        ...
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.message\.cover\]: msg\.exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.message\.cover\]: msg\.exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.message\.cover\]: msg\.match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.message\.cover\]: msg\.match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Main + Message', () => {
    it('Case 17: Main + message combination supports exact and match', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.main\.message\]: main-message\.exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.main\.message\]: main-message\.exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.main\.message\]: main-message\.match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.main\.message\]: main-message\.match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Group + Message', () => {
    it('Case 18: Group(exact) + message combination', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.gx\]: group-exact-message-exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.gx\]: group-exact-message-exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.gx\]: group-exact-message-match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.gx\]: group-exact-message-match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 19: Group(match) + message combination', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.gm1\]: group-match-message-exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.gm1\]: group-match-message-exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.gm1\]: group-match-message-match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.gm1\]: group-match-message-match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 22: Group exact matching with default and explicit levels', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.only\.exact\.default\]: group exact default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.only\.exact\.explicit\]: group exact explicit.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Main + Group + Message', () => {
    it('Case 20: Main + group(exact) + message combination', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.mgx\]: mgx-message-exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.mgx\]: mgx-message-exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.mgx\]: mgx-message-match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.mgx\]: mgx-message-match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 21: Main + group(match) + message combination', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.mgm1\]: mgm-message-exact\.default.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.mgm1\]: mgm-message-exact\.explicit.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.mgm1\]: mgm-message-match\.default\.1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.mgm1\]: mgm-message-match\.explicit\.1.*\d\.\d+ms$/,
        ),
      );
    });
