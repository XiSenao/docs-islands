  ...
  describe('No Scope Restrictions', () => {
    it('Case 1: Rule without scope restrictions matches all logs, inherits levels', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        ...
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_b_1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_b_2.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_c.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 2: Rule.levels overrides logging.levels, union of all matched rules', () => {
      ...
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_a.*\d\.\d+ms$/,
        ),
      );
      ...
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.a\]: message A_c.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Main Scope Matching', () => {
    it('Case 3: Main scope matching with multiple rules', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_c.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test_b\[test\.case\.b\]: message B_a.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        3,
        expect.stringMatching(
          /\[Test1\]\[Test3\].*@docs-islands\/test_b\[test\.case\.b\]: message B_b_1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        4,
        expect.stringMatching(
          /\[Test1\]\[Test3\].*@docs-islands\/test_b\[test\.case\.b\]: message B_b_2.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test_b\[test\.case\.b\]: message B_c.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Group Scope Matching', () => {
    ...
    it('Case 5: Group glob pattern matching with *', () => {
      ...
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.a\]: message A_a.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_b_1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.a\]: message A_b_2.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test\[test\.case\.a\]: message A_c.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test_b\[test\.case\.b_1\]: message B_a.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        3,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test_b\[test\.case\.b_1\]: message B_b_1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        4,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test_b\[test\.case\.b_1\]: message B_b_2.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test1\]\[Test4\].*@docs-islands\/test_b\[test\.case\.b_1\]: message B_c.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        3,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.b_2\]: message A_B_a.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        5,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test\[test\.case\.b_2\]: message A_B_b_1.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        6,
        expect.stringMatching(
          /\[Test1\]\[Test2\].*@docs-islands\/test\[test\.case\.b_2\]: message A_B_b_2.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        3,
        expect.stringMatching(
          /\[Test1\]\[Test4\].*@docs-islands\/test\[test\.case\.b_2\]: message A_B_c.*\d\.\d+ms$/,
        ),
      );
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        4,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test_c\[test\.c\]: message A_B_C_a.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        4,
        expect.stringMatching(
          /\[Test4\].*@docs-islands\/test_c\[test\.c\]: message A_B_C_c.*\d\.\d+ms$/,
        ),
      );
    });
