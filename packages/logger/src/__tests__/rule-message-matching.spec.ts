    ...
    it('Case 8: Exact message matching', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        ...
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.message\]: slow query.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.message\]: request timeout.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Message Glob Patterns', () => {
    it('Case 9: Message glob pattern with *', () => {
      ...
      expect(consoleLogSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.case\.message\.match\]: worker sync finished.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.case\.message\.match\]: timeout: fetch user.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.case\.message\.match\]: primary database unavailable.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test2\]\[Test4\].*@docs-islands\/test\[test\.case\.message\.match\]: timeout: database unavailable.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 11: Multiple message rules matching same message, label order', () => {
      ...
      logger.error('request timeout user api', { elapsedTimeMs: 1.23 });

      expect(consoleErrorSpy).toHaveBeenCalledTimes(1);
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\]\[Test2\]\[Test3\].*@docs-islands\/test\[test\.case\.message\.order\]: request timeout user api.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 12: message: "*" matches all messages', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.audit\.login\]: login failed.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.audit\.login\]: login failed.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.audit\.logout\]: logout failed.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 14: Exact and wildcard coexist', () => {
      ...
      logger.error('request timeout', { elapsedTimeMs: 1.23 });
      logger.error('request timeout downstream', { elapsedTimeMs: 1.23 });

      expect(consoleErrorSpy).toHaveBeenCalledTimes(2);
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\]\[Test2\]\[Test3\].*@docs-islands\/test\[test\.case\.message\.mix\]: request timeout.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test2\]\[Test3\].*@docs-islands\/test\[test\.case\.message\.mix\]: request timeout downstream.*\d\.\d+ms$/,
        ),
      );
    });
  });
  ...
  describe('Combined Scope and Message', () => {
    it('Case 10: Main + group + message can combine', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.api\.fetch\]: retry request.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        2,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test\[test\.api\.fetch\]: request timeout.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.api\.fetch\]: request timeout.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        3,
        expect.stringMatching(
          /\[Test3\].*@docs-islands\/test_b\[test\.api\.fetch\]: request timeout.*\d\.\d+ms$/,
        ),
      );
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        4,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.api\.update\]: retry request.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 13: Main + group + message all together use strict AND', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.payment\.charge\]: request timeout.*\d\.\d+ms$/,
        ),
      );
    });
    ...
    it('Case 15: Scope matches but message does not = no output', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test1\].*@docs-islands\/test\[test\.notify\.email\]: delivery failed.*\d\.\d+ms$/,
        ),
      );
      expect(consoleErrorSpy).toHaveBeenNthCalledWith(
        1,
        expect.stringMatching(
          /\[Test2\].*@docs-islands\/test\[test\.notify\.email\]: request timeout.*\d\.\d+ms$/,
        ),
      );
    });
  });
