...
- feat(logger): add cross-bundler loggerPlugin ([ffa63aa](https://github.com/XiSenao/docs-islands/commit/ffa63aa))
...
- chore(logger): pre-release preparation ([580ded8](https://github.com/XiSenao/docs-islands/commit/580ded8))
